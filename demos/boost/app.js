// Boost Converter interactive demo (v1.1)
...
function compute(){
  ...
  const di_off=(Vi-Vo)/L*(D*Ts), di_on=(-Vo)/L*((1-D)*Ts), dIL=di_on, ILavg=Io, ILmin=ILavg-dIL/2, ILmax=ILavg+dIL/2;
  for(let k=0;k<N;k++){
